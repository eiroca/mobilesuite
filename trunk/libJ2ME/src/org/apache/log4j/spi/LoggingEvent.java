...
public class LoggingEvent {
  ...
  /**
   * The category of the logging event. The category field is not serialized for
   * performance reasons.
   * <p>
  ...
  /**
   * Priority of logging event. Priority cannot be serializable because it is a
  ...
  /**
   * The throwable associated with this logging event. This is field is
   * transient because not all exception are serializable. More importantly, the
   * stack information does not survive serialization.
   */
   ...
   * to generate the logging event. After serialization, the returned value
   * equals the String form of the message possibly after object rendering.
   * @since 1.1
   */
