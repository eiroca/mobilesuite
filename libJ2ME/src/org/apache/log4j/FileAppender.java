...
public class FileAppender extends AppenderSkeleton {
   ...
   * output file will be truncated or appended to. Current value of this string
   * constant is <b>Append</b>.
   * <p>
   * Note that all option keys are case sensitive.
   */
  ...
  /**
   * Set FileAppender specific options. The recognized options are <b>File</b>
   * and <b>Append</b>, i.e. the values of the string constants
   * {@link #FILE_OPTION} and respectively {@link #APPEND_OPTION}. The options
   * of the super class {@link AppenderSkeleton} are also recognized.
   * <p>
   ...
   * <p>
   * If the option is set to "System.out" or "System.err" the output will go to
   * the corresponding stream. Otherwise, if the option is set to the name of a
   * file, then the file will be opened and output will go there.
   * <p>
   ...
   * was opened by the user and passed to this method, then the previous stream
   * remains untouched. It is the user's responsability to close it.
   * <p>
   ...
   * <p>
   * Most sub-classes of <code>FileAppender</code> will need to override this
   * method.
   * @since 0.9.0
   */
