...
public abstract class AppenderSkeleton implements Appender, OptionHandler {
   ...
   * actual logging to the subclasses specific method.
   */
  ...
  /**
   * Configurable Appenders should override this method if they admit additional
   * options. All classes derived from {@link AppenderSkeleton} admit the
   * <b>Threshold</b> option, that is the value of the string constant
   * {@link #THRESHOLD_OPTION}. See {@link #setThreshold} method for the
   ...
   * <b>Threshold</b> option to a priority string, such as "DEBUG", "INFO" and
   * so on.
   * @since 0.8.3
   */
